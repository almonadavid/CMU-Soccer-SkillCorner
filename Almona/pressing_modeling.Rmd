...
**Explain:** We trained 200 models (20 hyperparameter combinations × 10 folds) and evaluated each one. The save_pred = TRUE option stores all the predictions so we can create detailed performance plots later.
